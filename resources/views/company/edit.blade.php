...
@section('content')
    ...
    <div class="col-md-12">
        ...
        {{Form::submit('Supprimer',['class' => 'btn btn-primary purplebtn pull-right confirm_action',"c_m_text"=>"Voulez-vous vraiment supprimer cette compagnie?",'style'=>'position: relative; top:-41px;'])}}
        {{Form::close()}}
    </div>
@endsection
