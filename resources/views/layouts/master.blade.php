...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded navbar-theme navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <div class="nav navbar-nav navbar-right">
            ...
            @if (!Auth::check())
                <ul class="nav navbar-nav">
                    <li><a href="#" style="color: white"><span class="glyphicon glyphicon-user" style="color: white"></span> S'inscrire</a></li>
                    <li><a href="" style="color: white"><span class="glyphicon glyphicon-log-in" style="color: white"></span> Se Connecter</a></li>
                </ul>
            @else
                <ul class="nav navbar-nav">
