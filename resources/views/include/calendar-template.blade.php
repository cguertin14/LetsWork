    ...
    <div class="events">
        <ul class="schedule-ul">
            <li class="events-group" v-for="day in days">
                ...
                <ul>
                    <li class="single-event" :data-start="event.start" :data-end="event.end" :data-content="event.content" data-event="event-2" v-if="thisdayhaveanevent(day)" v-for="event in getevent(day)">
                        <a href="#0">
