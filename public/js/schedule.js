$(document).ready(function () {
    ...
    var calendarVue = new Vue({
        ...
        computed: {},
        methods: {
            thisdayhaveanevent: function thisdayhaveanevent(day) {
                return this.weekevents[day] !== 'undefined';
            },
            getevent: function getevent(day) {
            ...
            getNextDayFromStringDay: function getNextDayFromStringDay(day) {
                switch (day) {
                    case 'Lundi':
                        return 'Mardi';break;
                    case 'Mardi':
            ...
            getStringDayFromNumberDay: function getStringDayFromNumberDay(day) {
                switch (day) {
                    case 0:
                        return 'Dimanche';break;
                    case 1:
            ...
            getDateFromDayInCurrentCalendarDate: function getDateFromDayInCurrentCalendarDate(day) {
                var date = new Date(myCalendar.getDate(false));
                switch (day) {
                    case 'Dimanche':
                        return new Date(date.setDate(date.getDate() - date.getDay() /* + 0*/));break;
                    case 'Lundi':
                        return new Date(date.setDate(date.getDate() - date.getDay() + 1));break;
                    case 'Mardi':
                        return new Date(date.setDate(date.getDate() - date.getDay() + 2));break;
                    case 'Mercredi':
                        return new Date(date.setDate(date.getDate() - date.getDay() + 3));break;
                    case 'Jeudi':
                        return new Date(date.setDate(date.getDate() - date.getDay() + 4));break;
                    case 'Vendredi':
                        return new Date(date.setDate(date.getDate() - date.getDay() + 5));break;
                    case 'Samedi':
                        return new Date(date.setDate(date.getDate() - date.getDay() + 6));break;
                }
            },
            loadFromDate: function loadFromDate(date) {
                var self = this;
                self.weekevents = [];
    ...
    dhtmlXCalendarObject.prototype.langData["fr"] = {
        ...
        monthesSNames: ["Janv", "Févr", "Mar", "Avr", "Mai", "Juin", "Juill", "Août", "Sept", "Oct", "Nov", "Déc"],
        // full names of days
